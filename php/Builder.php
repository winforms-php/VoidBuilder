...
class Builder
{
    ...
    public function build (string $outputDir, string $iconPath = null, bool $union = true): array
    {
        ...
        return VoidEngine::compile ($outputDir .'/build/app.exe', $iconPath ?? dirname (__DIR__) .'/system/Icon.ico', self::optimizeCode (\VoidEngine\str_replace_assoc (file_get_contents (dirname (__DIR__) .'/system/preset.php'), [
